(() => {
  ...
  simulateBtn.addEventListener("click", async () => {
    ...
    if(end != null) {
      ...
      nm.push({
        content: `Simulation finished, the shortest path is of length ${i-1}.`,
        style: "success",
        icon: "checkmark-outline"
      });
    } else {
      nm.push({
        content: "No path was found from start to target.",
        style: "error",
        icon: "golf-outline"
      });
    }
  ...
  resetBtn.addEventListener("click", () => {
    ...
    activateFields();
    nm.push({
      content: "Simulation was successfully reset.",
      style: "success",
  ...
  nm.push({
    ...
    <br><span style="color:#6d6d6d;font-size:10px;display:inline-block;margin-top:4px;">by @RiadLoukili</span>`,
